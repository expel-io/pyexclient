...
class Actors(ResourceInstance):
    ...
    _def_relationships = ["analysis_assigned_investigative_actions", "assigned_expel_alerts", "assigned_investigations", "assigned_investigative_actions", "assigned_organization_resilience_actions",
                          "assigned_organization_resilience_actions_list", "assigned_remediation_actions", "child_actors", "created_by", "notification_preferences", "organization", "parent_actor", "updated_by", "user_account"]
...
class ContextLabelActions(ResourceInstance):
    ...
    _def_attributes = ["action_type", "created_at", "updated_at"]
    _def_relationships = ["context_label", "created_by", "investigation", "timeline_entries", "updated_by"]
...
class ContextLabels(ResourceInstance):
    ...
    _def_attributes = ["created_at", "definition", "description",
                       "ends_at", "metadata", "starts_at", "title", "updated_at"]
    _def_relationships = ["add_to_actions", "alert_on_actions", "context_label_actions", "context_label_tags",
                          "created_by", "expel_alerts", "investigations", "organization", "suppress_actions", "timeline_entries", "updated_by"]
...
class EngagementManagers(ResourceInstance):
    ...
    _def_attributes = ["created_at", "display_name", "email", "phone_number", "updated_at"]
...
class ExpelAlerts(ResourceInstance):
    ...
    _def_attributes = ["activity_first_at", "activity_last_at", "alert_type", "close_comment", "close_reason", "created_at", "cust_disp_alerts_in_critical_incidents_count", "cust_disp_alerts_in_incidents_count", "cust_disp_alerts_in_investigations_count", "cust_disp_closed_alerts_count", "cust_disp_disposed_alerts_count", "disposition_alerts_in_critical_incidents_count",
                       "disposition_alerts_in_incidents_count", "disposition_alerts_in_investigations_count", "disposition_closed_alerts_count", "disposition_disposed_alerts_count", "expel_alert_time", "expel_alias_name", "expel_message", "expel_name", "expel_severity", "expel_signature_id", "expel_version", "git_rule_url", "ref_event_id", "status", "status_updated_at", "tuning_requested", "updated_at", "vendor_alert_count"]
    _def_relationships = ["assigned_to_actor", "coincident_vendor_alerts", "context_labels", "created_by", "destination_ip_addresses", "evidence", "expel_alert_histories", "investigation", "investigative_action_histories", "investigative_actions",
                          "organization", "phishing_submissions", "related_investigations", "related_investigations_via_involved_host_ips", "similar_alerts", "source_ip_addresses", "status_last_updated_by", "updated_by", "vendor", "vendor_alerts"]
...
class Features(ResourceInstance):
    ...
    _def_relationships = ["created_by", "organizations", "products", "updated_by"]
...
class Investigations(ResourceInstance):
    ...
    _def_attributes = ["analyst_severity", "attack_lifecycle", "attack_timing", "attack_vector", "close_comment", "created_at", "critical_comment", "decision", "deleted_at", "detection_type", "has_hunting_status", "is_downgrade", "is_incident",
                       "is_incident_status_updated_at", "is_surge", "last_published_at", "last_published_value", "lead_description", "open_comment", "properties", "review_requested_at", "short_link", "source_reason", "status_updated_at", "threat_type", "title", "updated_at"]
    _def_relationships = ["assigned_to_actor", "comment_histories", "comments", "context_label_actions", "context_labels", "created_by", "destination_ip_addresses", "evidence", "expel_alert_histories", "expel_alerts", "files", "findings", "investigation_finding_histories", "investigation_histories", "investigation_resilience_actions", "investigative_action_histories", "investigative_actions",
                          "ip_addresses", "last_published_by", "lead_expel_alert", "organization", "organization_resilience_action_hints", "organization_resilience_actions", "related_investigations_via_involved_host_ips", "remediation_action_asset_histories", "remediation_action_histories", "remediation_actions", "review_requested_by", "source_ip_addresses", "status_last_updated_by", "timeline_entries", "updated_by"]
...
class InvestigativeActions(InvestigativeActionsResourceInstance):
    ...
    _def_attributes = ["action_type", "activity_authorized", "activity_verified_by", "capability_name", "close_reason", "created_at", "deleted_at", "downgrade_reason", "files_count", "input_args", "instructions",
                       "reason", "result_byte_size", "result_task_id", "results", "robot_action", "status", "status_updated_at", "taskability_action_id", "tasking_error", "title", "updated_at", "workflow_job_id", "workflow_name"]
...
class Organizations(ResourceInstance):
    ...
    _def_relationships = ["actor", "analysis_assigned_investigative_actions", "api_keys", "assemblers", "assignables", "assigned_expel_alerts", "assigned_investigations", "assigned_investigative_actions", "assigned_organization_resilience_actions", "assigned_organization_resilience_actions_list", "assigned_remediation_actions", "comments", "configurations", "context_label_tags", "context_labels", "created_by", "engagement_manager",
                          "expel_alert_histories", "expel_alerts", "features", "files", "integrations", "investigation_histories", "investigations", "nist_subcategory_scores", "notification_preferences", "organization_resilience_action_groups", "organization_resilience_actions", "organization_status", "organization_user_account_roles", "products", "saml_identity_provider", "security_devices", "updated_by", "user_accounts", "user_accounts_with_roles", "vendor_alerts"]
...
class PhishingSubmissions(ResourceInstance):
    ...
    _def_attributes = ["automated_action_type", "created_at", "email_type", "msg_id", "received_at", "reported_at",
                       "return_path", "sender", "sender_domain", "subject", "submitted_by", "triaged_at", "updated_at"]
...
class Products(ResourceInstance):
    ...
    '''
    _api_type = 'products'
    _def_attributes = ["created_at", "description", "name", "updated_at"]
    _def_relationships = ["created_by", "features", "organizations", "updated_by"]
...
class RemediationActionAssets(ResourceInstance):
    ...
    _def_attributes = ["asset_type", "category", "created_at", "status", "updated_at", "value"]
...
class RemediationActionHistories(ResourceInstance):
    ...
    _def_attributes = ["action", "action_type", "created_at", "value"]
    _def_relationships = ["assigned_to_actor", "created_by", "investigation", "remediation_action"]
...
class RemediationActions(ResourceInstance):
    ...
    _def_attributes = ["action", "action_type", "close_reason", "comment", "created_at", "deleted_at",
                       "detail_markdown", "status", "status_updated_at", "template_name", "updated_at", "values", "version"]
    _def_relationships = ["assigned_to_actor", "created_by", "investigation",
                          "remediation_action_assets", "remediation_action_histories", "updated_by"]
...
class SecurityDevices(ResourceInstance):
    ...
    _def_attributes = ["created_at", "deleted_at", "device_spec", "device_type", "has_two_factor_secret", "location",
                       "name", "plugin_slug", "status", "status_details", "status_updated_at", "task_source", "updated_at"]
    _def_relationships = ["assembler", "child_security_devices", "created_by", "investigative_actions",
                          "organization", "parent_security_device", "updated_by", "vendor", "vendor_alerts"]
...
class UserAccounts(ResourceInstance):
    ...
    _def_attributes = ["active", "active_status", "assignable", "created_at", "display_name", "email", "engagement_manager",
                       "first_name", "homepage_preferences", "language", "last_name", "locale", "phone_number", "timezone", "updated_at"]
    _def_relationships = ["actor", "analysis_assigned_investigative_actions", "assigned_expel_alerts", "assigned_investigations", "assigned_investigative_actions", "assigned_organization_resilience_actions",
                          "assigned_organization_resilience_actions_list", "assigned_remediation_actions", "created_by", "notification_preferences", "organizations", "primary_organization", "updated_by", "user_account_roles", "user_account_status"]

...
MACGYVER_FIELD_TO_TYPE_GEN = {'actor': 'actors',
                              ...
                              't_and_c_confirmed_actor': 'actors',
...
class Actors(ResourceInstance):
    ...
    _def_relationships = ["analysis_assigned_investigative_actions", "assigned_expel_alerts", "assigned_investigations", "assigned_investigative_actions", "assigned_organization_resilience_actions", "assigned_organization_resilience_actions_list",
                          "assigned_remediation_actions", "automate_opt_in_for_remediation_action_setting", "child_actors", "child_organizations", "created_by", "notification_preferences", "organization", "parent_actor", "updated_by", "user_account"]
...
class ContextVariables(ResourceInstance):
    ...
    .. code-block:: javascript
        ...
        {'created_at': '2019-01-15T15:35:00-05:00', 'description': 'string', 'name': 'string', 'updated_at': '2019-01-15T15:35:00-05:00', 'value': 'object', 'value_type': 'string'}
    ...
    Below are valid filter by parameters:
        ...
        +------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+----------------------------+---------------+------------------+
        | Unique name of this context variable                                                                                                                                                                                                                       | name               | string                     | Y             | N                |
        +------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+----------------------------+---------------+------------------+
        | Last Updated timestamp: readonly                                                                                                                                                                                                                           | updated_at         | string                     | Y             | N                |
        +------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+----------------------------+---------------+------------------+
        | Value of this context variable: no-sort                                                                                                                                                                                                                    | value              | any                        | Y             | N                |
        +------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+----------------------------+---------------+------------------+
        | Value type of this context variable Restricted to: "string", "integer", "ip_address", "cidr_block", "regex", "email_address", "string_array", "integer_array", "ip_address_array", "cidr_block_array", "regex_array", "email_address_array": immutable     | value_type         | any                        | Y             | N                |
        +------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+----------------------------+---------------+------------------+
        | Defines/retrieves expel.io context_label records                                                                                                                                                                                                           | context_labels     | :class:`ContextLabels`     | N             | Y                |
        +------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+----------------------------+---------------+------------------+
        | Defines/retrieves expel.io actor records                                                                                                                                                                                                                   | created_by         | :class:`Actors`            | N             | Y                |
    ...
    _def_attributes = ["created_at", "description", "name", "updated_at", "value", "value_type"]
    _def_relationships = ["context_labels", "created_by", "organization", "updated_by"]
...
class Detections(ResourceInstance):
    ...
    _def_attributes = ["author_type", "configuration_slugs", "created_at", "created_date", "customer_context_tags", "description",
                       "logic_blob", "name", "priority", "severity", "status", "supported_tech", "tags", "test_blob", "unique_on", "unique_within", "updated_at"]
...
class ExpelAlerts(ResourceInstance):
    ...
    Below are valid filter by parameters:
        ...
        +---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------+-------------------------------------------+---------------+------------------+
        | Expel alert close reason Restricted to: "FALSE_POSITIVE", "TRUE_POSITIVE", "OTHER", "ATTACK_FAILED", "POLICY_VIOLATION", "ACTIVITY_BLOCKED", "TESTING", "PUP_PUA", "BENIGN", "IT_MISCONFIGURATION", "INCONCLUSIVE", "SUPPRESSED", "PHISHING_SIMULATION", "SUPPRESSED_NEW_DEVICE" Allows: null     | close_reason                                       | any                                       | Y             | N                |
        +---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------+-------------------------------------------+---------------+------------------+
        | Created timestamp: readonly                                                                                                                                                                                                                                                                       | created_at                                         | string                                    | Y             | N                |
        +---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------+-------------------------------------------+---------------+------------------+
    ...
    _def_attributes = ["activity_first_at", "activity_last_at", "alert_type", "close_comment", "close_reason", "created_at", "cust_disp_alerts_in_critical_incidents_count", "cust_disp_alerts_in_incidents_count", "cust_disp_alerts_in_investigations_count", "cust_disp_closed_alerts_count", "cust_disp_disposed_alerts_count", "disposition_alerts_in_critical_incidents_count", "disposition_alerts_in_incidents_count", "disposition_alerts_in_investigations_count", "disposition_closed_alerts_count",
                       "disposition_disposed_alerts_count", "expel_alert_time", "expel_alias_name", "expel_message", "expel_name", "expel_severity", "expel_signature_id", "expel_version", "git_rule_url", "investigative_action_count", "ref_event_id", "status", "status_updated_at", "tuning_requested", "updated_at", "vendor_alert_count", "vendor_disp_alerts_in_critical_incidents_count", "vendor_disp_alerts_in_incidents_count", "vendor_disp_alerts_in_investigations_count", "vendor_disp_closed_alerts_count", "vendor_disp_disposed_alerts_count"]
    _def_relationships = ["assigned_to_actor", "context_labels", "created_by", "destination_ip_addresses", "evidence", "expel_alert_histories", "investigation", "investigative_action_histories", "investigative_actions", "organization", "originated_context_labels",
                          "phishing_submissions", "related_investigations", "related_investigations_via_involved_host_ips", "similar_alerts", "source_ip_addresses", "status_last_updated_by", "suggestions", "suppression_histories", "updated_by", "user_tasks", "vendor", "vendor_alerts"]
...
class Integrations(ResourceInstance):
    ...
    Below are valid filter by parameters:
        ...
        +--------------------------------------------------------------------------------------------------------------------------------------------+----------------------+----------------------------+---------------+------------------+
        | Type of integration Restricted to: "pagerduty", "slack", "ticketing", "service_now", "teams", "ops_genie", "o365_reporting": immutable     | integration_type     | any                        | Y             | N                |
        +--------------------------------------------------------------------------------------------------------------------------------------------+----------------------+----------------------------+---------------+------------------+
...
class InvestigativeActions(InvestigativeActionsResourceInstance):
    ...
    _def_attributes = ["action_type", "activity_authorized", "activity_verified_by", "capability_name", "close_reason", "content_driven_results", "created_at", "deleted_at", "downgrade_reason", "files_count", "input_args",
                       "instructions", "rank", "reason", "result_byte_size", "result_task_id", "results", "robot_action", "status", "status_updated_at", "taskability_action_id", "tasking_error", "title", "updated_at", "workflow_job_id", "workflow_name"]
    _def_relationships = ["analysis_assigned_to_actor", "assigned_to_actor", "created_by", "dependent_investigative_actions", "depends_on_investigative_action",
                          "expel_alert", "files", "investigation", "investigative_action_histories", "organization", "result_file", "security_device", "updated_by"]
...
class NotificationRules(ResourceInstance):
    ...
    .. code-block:: javascript
        ...
        {'destinations': [], 'short_name': 'string'}
    ...
    _def_attributes = ["destinations", "short_name"]
...
class Organizations(ResourceInstance):
    ...
    Below are valid filter by parameters:
        ...
        | Defines/retrieves expel.io suggestions                                                                        | suggestions                                        | :class:`Suggestions`                            | N             | Y                |
        +---------------------------------------------------------------------------------------------------------------+----------------------------------------------------+-------------------------------------------------+---------------+------------------+
        | Defines/retrieves expel.io actor records                                                                      | t_and_c_confirmed_actor                            | :class:`Actors`                                 | N             | Y                |
        +---------------------------------------------------------------------------------------------------------------+----------------------------------------------------+-------------------------------------------------+---------------+------------------+
        | Defines/retrieves expel.io actor records                                                                      | updated_by                                         | :class:`Actors`                                 | N             | Y                |
        +---------------------------------------------------------------------------------------------------------------+----------------------------------------------------+-------------------------------------------------+---------------+------------------+
    ...
    _def_attributes = ["address_1", "address_2", "city", "country_code", "created_at", "deleted_at", "hq_city", "hq_utc_offset", "industry", "is_surge", "is_testing_organization",
                       "name", "nodes_count", "o365_tos_id", "onboarding_preferences", "postal_code", "region", "service_renewal_at", "service_start_at", "short_name", "updated_at", "users_count"]
    _def_relationships = ["actor", "alert_assignables", "analysis_assigned_investigative_actions", "api_keys", "assemblers", "assigned_expel_alerts", "assigned_investigations", "assigned_investigative_actions", "assigned_organization_resilience_actions", "assigned_organization_resilience_actions_list", "assigned_remediation_actions", "automate_opt_in_for_remediation_action_setting", "comments", "configurations", "context_label_tags", "context_labels", "context_variables", "created_by", "engagement_manager", "entitlement", "expel_alert_histories", "expel_alerts", "files", "integrations",
                          "investigation_assignables", "investigation_histories", "investigations", "investigative_actions", "nist_subcategory_scores", "notification_preferences", "organization_resilience_action_groups", "organization_resilience_actions", "organization_status", "organization_user_account_roles", "parent_organization_actor", "remediation_action_setting_histories", "remediation_action_settings", "review_summaries", "saml_identity_provider", "security_devices", "suggestions", "t_and_c_confirmed_actor", "updated_by", "user_accounts", "user_accounts_with_roles", "user_tasks", "vendor_alerts"]
...
class RemediationActionAssets(ResourceInstance):
    ...
    _def_attributes = ["asset_type", "automate_revert", "automate_status", "automate_status_updated_at", "automate_task_error",
                       "automate_task_id", "automate_task_result_id", "cannot_automate_reason", "category", "created_at", "status", "updated_at", "value"]
...
class RuleDefinitions(ResourceInstance):
    ...
    .. code-block:: javascript
        ...
        {'event_definitions': [], 'owner_id': 'string', 'rule_action': 'string', 'rule_definition_type': 'UNSPECIFIED', 'rule_model': 'string'}
    ...
    _def_attributes = ["event_definitions", "owner_id", "rule_action", "rule_definition_type", "rule_model"]
    _def_relationships = []
...
class SecurityDevices(ResourceInstance):
    ...
    _def_attributes = ["created_at", "deleted_at", "device_spec", "device_type", "has_two_factor_secret", "is_verifying_status",
                       "location", "name", "plugin_slug", "properties", "status", "status_details", "status_updated_at", "task_source", "updated_at"]
    _def_relationships = ["assembler", "child_security_devices", "created_by", "investigative_actions", "organization", "parent_security_device",
                          "remediation_action_asset_histories", "remediation_action_assets", "remediation_action_histories", "remediation_actions", "updated_by", "vendor", "vendor_alerts"]
...
class Suggestions(ResourceInstance):
    ...
    Below are valid filter by parameters:
        ...
        | Visualization rank                                                     | rank                     | number                           | Y             | N                |
        +------------------------------------------------------------------------+--------------------------+----------------------------------+---------------+------------------+
        | Body of the suggestion Allows: "", null                                | suggestion               | string                           | Y             | N                |
        +------------------------------------------------------------------------+--------------------------+----------------------------------+---------------+------------------+
        | Last Updated timestamp: readonly                                       | updated_at               | string                           | Y             | N                |
        +------------------------------------------------------------------------+--------------------------+----------------------------------+---------------+------------------+
        | Defines/retrieves expel.io actor records                               | created_by               | :class:`Actors`                  | N             | Y                |
...
class UserAccounts(ResourceInstance):
    ...
    _def_relationships = ["actor", "analysis_assigned_investigative_actions", "assigned_expel_alerts", "assigned_investigations", "assigned_investigative_actions", "assigned_organization_resilience_actions", "assigned_organization_resilience_actions_list",
                          "assigned_remediation_actions", "automate_opt_in_for_remediation_action_setting", "created_by", "notification_preferences", "organizations", "primary_organization", "primary_user_account_role", "updated_by", "user_account_roles", "user_account_status"]

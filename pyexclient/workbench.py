...
class VendorAlerts(ResourceInstance):
    ...
    _def_attributes = ["first_seen", "status", "original_source_id", "evidence_summary", "updated_at", "signature_id", "vendor_severity", "created_at", "evidence_activity_end_at", "vendor_message", "evidence_activity_start_at", "original_alert_id", "description", "vendor_sig_name"]
    _def_relationships = ["updated_by", "assembler", "security_device", "evidences", "created_by", "organization", "ip_addresses", "expel_alerts", "vendor"]
...
class RemediationActionAssets(ResourceInstance):
    ...
    _def_relationships = ["remediation_action", "remediation_action_asset_histories", "context_label_tags", "updated_by", "created_by"]
...
class Integrations(ResourceInstance):
    ...
    _def_attributes = ["created_at", "integration_meta", "status", "integration_type", "account", "service_name", "updated_at", "last_tested_at"]
...
class RemediationActions(ResourceInstance):
    ...
    _def_attributes = ["values", "action", "template_name", "version", "status", "updated_at", "created_at", "status_updated_at", "close_reason", "detail_markdown", "action_type", "comment", "deleted_at"]
    _def_relationships = ["updated_by", "assigned_to_actor", "investigation", "created_by", "remediation_action_assets", "remediation_action_histories"]
...
class UserAccountStatuses(ResourceInstance):
    ...
    _def_attributes = ["created_at", "active", "restrictions", "invite_token_expires_at", "password_reset_token_expires_at", "active_status", "updated_at"]
...
class Files(FilesResourceInstance):
    ...
    _def_relationships = ["updated_by", "investigations", "created_by", "investigative_actions", "phishing_submission_attachment", "organization", "phishing_submission"]
...
class PhishingSubmissions(ResourceInstance):
    ...
    _def_attributes = ["email_type", "sender_domain", "msg_id", "reported_at", "updated_at", "subject", "automated_action_type", "created_at", "received_at", "submitted_by", "sender", "return_path", "triaged_at"]
    _def_relationships = ["phishing_submission_domains", "phishing_submission_attachments", "analysis_email_file", "raw_body_file", "created_by", "initial_email_file", "phishing_submission_headers", "updated_by", "phishing_submission_urls", "expel_alert"]
...
class ExpelAlerts(ResourceInstance):
    ...
    _def_attributes = ["disposition_disposed_alerts_count", "close_comment", "tuning_requested", "status", "git_rule_url", "disposition_closed_alerts_count", "updated_at", "status_updated_at", "created_at", "expel_version", "close_reason", "activity_last_at", "disposition_alerts_in_critical_incidents_count", "disposition_alerts_in_incidents_count", "cust_disp_alerts_in_critical_incidents_count", "expel_signature_id", "expel_severity", "alert_type", "disposition_alerts_in_investigations_count", "cust_disp_alerts_in_investigations_count", "cust_disp_disposed_alerts_count", "ref_event_id", "expel_message", "expel_name", "vendor_alert_count", "cust_disp_closed_alerts_count", "expel_alert_time", "cust_disp_alerts_in_incidents_count", "activity_first_at", "expel_alias_name"]
    _def_relationships = ["source_ip_addresses", "assigned_to_actor", "phishing_submissions", "investigative_actions", "created_by", "expel_alert_histories", "vendor_alerts", "destination_ip_addresses", "similar_alerts", "investigative_action_histories", "vendor", "updated_by", "related_investigations_via_involved_host_ips", "evidence", "investigation", "related_investigations", "coincident_vendor_alerts", "organization", "status_last_updated_by", "context_labels"]
...
class AssemblerImages(ResourceInstance):
    ...
    _def_attributes = ["created_at", "hash_sha256", "release_date", "platform", "size", "hash_md5", "hash_sha1", "version", "updated_at"]
    _def_relationships = ["updated_by", "created_by"]
...
class SecurityDevices(ResourceInstance):
    ...
    _def_attributes = ["status", "status_details", "status_updated_at", "plugin_slug", "updated_at", "deleted_at", "created_at", "device_spec", "location", "task_source", "name", "has_two_factor_secret", "device_type"]
    _def_relationships = ["updated_by", "assembler", "created_by", "child_security_devices", "investigative_actions", "vendor_alerts", "organization", "parent_security_device", "vendor"]
...
class TimelineEntries(ResourceInstance):
    ...
    _def_attributes = ["created_at", "event", "event_type", "src_host", "dest_host", "event_date", "attack_phase", "updated_at", "comment", "deleted_at", "is_selected"]
    _def_relationships = ["updated_by", "context_label_actions", "investigation", "created_by", "context_labels", "expel_alert"]
...
class Organizations(ResourceInstance):
    ...
    _def_attributes = ["city", "region", "address_2", "hq_city", "updated_at", "country_code", "is_surge", "users_count", "created_at", "service_renewal_at", "industry", "name", "address_1", "postal_code", "short_name", "nodes_count", "service_start_at", "deleted_at", "hq_utc_offset", "o365_tos_id"]
    _def_relationships = ["updated_by", "nist_subcategory_scores", "actor", "created_by", "notification_preferences", "assigned_remediation_actions", "api_keys", "configurations", "assigned_organization_resilience_actions", "investigations", "engagement_manager", "vendor_alerts", "assigned_organization_resilience_actions_list", "integrations", "organization_resilience_action_groups", "assigned_investigative_actions", "files", "user_accounts", "investigation_histories", "expel_alert_histories", "analysis_assigned_investigative_actions", "features", "organization_status", "user_accounts_with_roles", "saml_identity_provider", "assemblers", "organization_resilience_actions", "expel_alerts", "products", "context_labels", "assigned_investigations", "security_devices", "assigned_expel_alerts", "assignables", "context_label_tags", "comments", "organization_user_account_roles"]
...
class NistSubcategoryScores(ResourceInstance):
    ...
    _def_attributes = ["category_name", "actual_score", "assessment_date", "updated_at", "subcategory_identifier", "target_score", "function_type", "created_at", "is_priority", "subcategory_name", "category_identifier", "comment"]
    _def_relationships = ["updated_by", "organization", "nist_subcategory_score_histories", "nist_subcategory", "created_by"]
...
class Actors(ResourceInstance):
    ...
    _def_relationships = ["updated_by", "analysis_assigned_investigative_actions", "child_actors", "user_account", "created_by", "assigned_remediation_actions", "assigned_organization_resilience_actions", "notification_preferences", "assigned_expel_alerts", "parent_actor", "assigned_organization_resilience_actions_list", "organization", "assigned_investigations", "assigned_investigative_actions"]
...
class OrganizationResilienceActionGroups(ResourceInstance):
    ...
    _def_relationships = ["updated_by", "organization", "organization_resilience_action_group_actions", "created_by", "source_resilience_action_group"]
...
class ApiKeys(ResourceInstance):
    ...
    '''
    _api_type = 'api_keys'
    _def_attributes = ["access_token", "created_at", "active", "display_name", "assignable", "name", "realm", "role", "updated_at"]
    _def_relationships = ["updated_by", "organization", "created_by"]
...
class InvestigativeActions(InvestigativeActionsResourceInstance):
    ...
    _def_attributes = ["capability_name", "activity_verified_by", "input_args", "activity_authorized", "result_byte_size", "downgrade_reason", "created_at", "result_task_id", "close_reason", "robot_action", "taskability_action_id", "workflow_name", "status", "action_type", "deleted_at", "updated_at", "title", "instructions", "tasking_error", "status_updated_at", "reason", "workflow_job_id", "files_count", "results"]
    _def_relationships = ["updated_by", "assigned_to_actor", "investigation", "depends_on_investigative_action", "created_by", "dependent_investigative_actions", "security_device", "expel_alert", "investigative_action_histories", "files", "analysis_assigned_to_actor"]
...
class UserAccounts(ResourceInstance):
    ...
    _def_attributes = ["active", "assignable", "locale", "engagement_manager", "last_name", "updated_at", "email", "created_at", "display_name", "language", "timezone", "phone_number", "active_status", "homepage_preferences", "first_name"]
    _def_relationships = ["updated_by", "actor", "primary_organization", "created_by", "assigned_remediation_actions", "user_account_roles", "analysis_assigned_investigative_actions", "assigned_organization_resilience_actions", "notification_preferences", "assigned_expel_alerts", "assigned_organization_resilience_actions_list", "user_account_status", "assigned_investigations", "assigned_investigative_actions", "organizations"]
...
class Assemblers(ResourceInstance):
    ...
    _def_attributes = ["lifecycle_status_updated_at", "install_code", "lifecycle_status", "connection_status", "updated_at", "created_at", "status_updated_at", "location", "connection_status_updated_at", "name", "status", "deleted_at", "vpn_ip"]
...
class IpAddresses(ResourceInstance):
    ...
    _def_relationships = ["updated_by", "investigations", "created_by", "source_expel_alerts", "vendor_alerts", "destination_investigations", "destination_expel_alerts", "source_investigations"]
...
class OrganizationResilienceActions(ResourceInstance):
    ...
    _def_attributes = ["created_at", "details", "title", "visible", "status", "category", "updated_at", "comment", "impact"]
    _def_relationships = ["updated_by", "assigned_to_actor", "investigation_resilience_actions", "source_resilience_action", "created_by", "organization", "organization_resilience_action_group", "investigations", "investigation_hints"]
...
class Configurations(ResourceInstance):
    ...
    _def_attributes = ["metadata", "description", "default_value", "title", "key", "write_permission_level", "updated_at", "created_at", "validation", "value", "is_override", "visibility"]
    _def_relationships = ["updated_by", "organization", "created_by"]
...
class ContextLabels(ResourceInstance):
    ...
    _def_attributes = ["created_at", "metadata", "description", "title", "starts_at", "definition", "updated_at", "ends_at"]
    _def_relationships = ["updated_by", "context_label_actions", "timeline_entries", "add_to_actions", "suppress_actions", "created_by", "organization", "alert_on_actions", "context_label_tags", "expel_alerts", "investigations"]
